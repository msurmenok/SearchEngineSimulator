...
public class DynamicPageRankerView
{
	...
	public DynamicPageRankerView(WebPage[] urls, String defaultKeyword, BinarySearchTree T)
	{
		this.urls = urls;
		BinarySearchTree bst = T;
		...
		searchButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				{
					BinarySearchTree.treeInsert(bst, url);
				}
		...
		searchUrlButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				WebPage page = bst.getDataByRank(rank);
		...
		deleteUrlButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				TreeNode nodeToDelete = bst.treeSearch(score);

				// Delete node if found one
				if (nodeToDelete != null)
				{
					BinarySearchTree.treeDelete(bst, nodeToDelete);
				}
		...
		JFrame frame = new JFrame("Page Ranker using BST");
